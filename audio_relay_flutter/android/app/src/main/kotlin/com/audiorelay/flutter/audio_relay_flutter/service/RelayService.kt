...
import com.audiorelay.flutter.audio_relay_flutter.state.PairedLaptop
import com.audiorelay.flutter.audio_relay_flutter.state.RelayState
import com.audiorelay.flutter.audio_relay_flutter.state.SettingsStore
import com.audiorelay.flutter.audio_relay_flutter.state.ThemeMode
...
class RelayService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        when (intent?.action) {
            ACTION_CONNECT -> {
                val deviceId = intent.getStringExtra(EXTRA_DEVICE_ID) ?: "desktop-manual"
    ...
    private fun buildNotification(streamingFrom: String?): Notification {
        ...
        val text = if (streamingFrom != null) {
            "Streaming audio from $streamingFrom"
        } else {
            "Ready to connect"
        }
